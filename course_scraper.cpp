...
int main() {
    ...
    std::string html_document = get_request("https://courses.rice.edu/courses/!SWKSCAT.cat?p_acyr_code=2025&p_action=CATASRCH&p_onebar=&p_mode=AND&p_subj_cd=&p_subj=&p_dept=&p_school=&p_df=All&p_submit=&as_fid=e46b1edbbd7176e34949b9ae7bac9c4a9cc20043"); // target page
